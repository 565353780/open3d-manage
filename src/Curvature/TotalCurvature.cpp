...
double TotalCurvature::PerTriangleLaplacianCurvature(int row_id,
  ...
  v_adjacent_face = V({adjacent_face(0), adjacent_face(1), adjacent_face(2)},
                      Eigen::indexing::all);
  n_adjacent_face = N({adjacent_face(0), adjacent_face(1), adjacent_face(2)},
                      Eigen::indexing::all);
...
void TotalCurvature::TotalCurvatureMesh(const Eigen::MatrixXd &V,
                                        const Eigen::MatrixXi &F,
                                        const Eigen::MatrixXd &N,
                                        Eigen::VectorXd &k_S) {
