...
CurvatureUtils::VertexFaceAdjacency(const Eigen::MatrixXi &F) {
...
CurvatureUtils::CotangentLaplacian(const Eigen::MatrixXd &V,
...
Eigen::MatrixXd
CurvatureUtils::ComputeDoubleFaceAreas(const Eigen::MatrixXd &V,
                                       const Eigen::MatrixXi &F) {
